									...
									<tbody>
                                        ...
                                        @foreach ($allcart as $product)
                                          ...
                                          <tr>
											<td class="product-col">
												<div class="product">
													<figure class="product-media">
														<a href="#">
															<img src="{{asset('upload/product/'.$product->attributes->image)}}" alt="Product image">
														</a>
													</figure>
											...
											<td class="total-col">৳ {{ $product->getPriceSum() }}</td>
											<td class="remove-col">
                                                <a href="{{ route('cart.destroy',$product->id) }}" class="btn-remove">
