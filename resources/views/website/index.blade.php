...
<main class="main">
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="intro-slider-container slider-container-ratio mb-2 mb-lg-0">
						<div class="intro-slider owl-carousel owl-simple owl-dark owl-nav-inside" data-toggle="owl" data-owl-options='{
							...
							<div class="intro-slide">
								<figure class="slide-image">
									<picture>
										<source media="(max-width: 480px)" srcset="{{asset('content/website')}}/assets/images/demos/demo-3/slider/slide-1-480w.jpg"> <img src="{{asset('content/website')}}/assets/images/demos/demo-3/slider/slide-1.jpg" alt="Image Desc"> </picture>
								</figure>
								<!-- End .slide-image -->
								<div class="intro-content">
									...
									<!-- End .intro-title -->
									<div class="intro-price"> <sup>Today:</sup> <span class="text-primary">
                                                    $247<sup>.99</sup>
                                                </span> </div>
									<!-- End .intro-price -->
									<a href="category.html" class="btn btn-primary btn-round"> <span>Click Here</span> <i class="icon-long-arrow-right"></i> </a>
								</div>
								<!-- End .intro-content -->
							</div>
							<!-- End .intro-slide -->
							<div class="intro-slide">
								<figure class="slide-image">
									<picture>
										<source media="(max-width: 480px)" srcset="{{asset('content/website')}}/assets/images/demos/demo-3/slider/slide-2-480w.jpg"> <img src="{{asset('content/website')}}/assets/images/demos/demo-3/slider/slide-2.jpg" alt="Image Desc"> </picture>
								</figure>
								<!-- End .slide-image -->
								<div class="intro-content">
									...
									<!-- End .intro-title -->
									<div class="intro-price"> <sup class="intro-old-price">$49,99</sup> <span class="text-primary">
                                                    $29<sup>.99</sup>
                                                </span> </div>
									<!-- End .intro-price -->
									<a href="category.html" class="btn btn-primary btn-round"> <span>Click Here</span> <i class="icon-long-arrow-right"></i> </a>
						...
						<!-- End .intro-slider owl-carousel owl-simple --><span class="slider-loader"></span>
						<!-- End .slider-loader -->
					</div>
				...
				<div class="col-lg-4">
					<div class="intro-banners">
						<div class="banner mb-lg-1 mb-xl-2">
							<a href="#"> <img src="{{asset('content/website')}}/assets/images/demos/demo-3/banners/banner-1.jpg" alt="Banner"> </a>
							<div class="banner-content">
								...
								<!-- End .banner-title --><a href="#" class="banner-link">Shop Now<i class="icon-long-arrow-right"></i></a> </div>
							<!-- End .banner-content -->
						</div>
						<!-- End .banner -->
						<div class="banner mb-lg-1 mb-xl-2">
							<a href="#"> <img src="{{asset('content/website')}}/assets/images/demos/demo-3/banners/banner-2.jpg" alt="Banner"> </a>
							<div class="banner-content">
						...
						<div class="banner mb-0">
							<a href="#"> <img src="{{asset('content/website')}}/assets/images/demos/demo-3/banners/banner-3.jpg" alt="Banner"> </a>
							<div class="banner-content">
		...
		<div class="tab-content tab-content-carousel">
			...
			<div class="tab-pane p-0 fade show active" id="products-sale-tab" role="tabpanel" aria-labelledby="products-sale-link">
                ...
                @foreach ( $productsale as $saledata )
					<div class="product product-2">
						...
						<!-- End .product-media -->
						<div class="product-body">
							<div class="product-cat"> <a href="#">{{ Str::words($saledata->category->pro_cate_name,5) }}</a> </div>
							<!-- End .product-cat -->
							<h3 class="product-title"><a href="">{{ Str::words($saledata->product_name,6) }}</a></h3>
							<!-- End .product-title -->
            ...
            @foreach ( $producttop as $topdata )
					<div class="product product-2">
						...
						<!-- End .product-media -->
						<div class="product-body">
							<div class="product-cat"> <a href="{{ url('productview/'.$topdata->product_slug) }}">{{ $topdata->category->pro_cate_name }}</a> </div>
							<!-- End .product-cat -->
							<h3 class="product-title"><a href="{{ url('productview/'.$topdata->product_slug) }}">{{ Str::words($topdata->product_name,6)}}</a></h3>
							<!-- End .product-title -->
	...
	<!-- End .mb-7 -->
	<div class="container">
		<div class="cta cta-border cta-border-image mb-5 mb-lg-7" style="background-image: url({{asset('content/website')}}/assets/images/demos/demo-3/bg-1.jpg);">
			<div class="cta-border-wrapper bg-white">
				<div class="row justify-content-center">
					<div class="col-md-11 col-xl-11">
						<div class="cta-content">
							<div class="cta-heading">
								<h3 class="cta-title text-right"><span class="text-primary">New Deals</span> <br>Start Daily at 12pm e.t.</h3>
								<!-- End .cta-title -->
							</div>
							<!-- End .cta-heading -->
							<div class="cta-text">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6 deal-col">
					<div class="deal" style="background-image: url('{{asset('content/website')}}/assets/images/demos/demo-3/deal/bg-1.jpg');">
						<div class="deal-top">
							<h2>Deal of the Day.</h2>
							<h4>Limited quantities. </h4> </div>
						<!-- End .deal-top -->
						<div class="deal-content">
							<h3 class="product-title"><a href="product.html">Home Smart Speaker with  Google Assistant</a></h3>
							<!-- End .product-title -->
							<div class="product-price"> <span class="new-price">$129.00</span> <span class="old-price">Was $150.99</span> </div>
							<!-- End .product-price --><a href="product.html" class="btn btn-link"><span>Shop Now</span><i class="icon-long-arrow-right"></i></a> </div>
						<!-- End .deal-content -->
				...
				<div class="col-lg-6">
					<div class="products">
						<div class="row">
							<div class="col-6">
								<div class="product product-2">
									<figure class="product-media"> <span class="product-label label-circle label-top">Top</span> <span class="product-label label-circle label-sale">Sale</span>
										<a href="product.html"> <img src="{{asset('content/website')}}/assets/images/demos/demo-3/products/product-5.jpg" alt="Product image" class="product-image"> </a>
										<div class="product-action-vertical"> <a href="#" class="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a> </div>
										<!-- End .product-action -->
									...
									<div class="product-body">
										...
										<!-- End .product-title -->
										<div class="product-price"> <span class="new-price">$3,599.99</span> <span class="old-price">Was $3,999.99</span> </div>
										<!-- End .product-price -->
										<div class="ratings-container">
											<div class="ratings">
							...
							<div class="col-6">
								<div class="product product-2">
									<figure class="product-media"> <span class="product-label label-circle label-sale">Sale</span>
										<a href="product.html"> <img src="{{asset('content/website')}}/assets/images/demos/demo-3/products/product-6.jpg" alt="Product image" class="product-image"> </a>
										<div class="product-action-vertical"> <a href="#" class="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a> </div>
										<!-- End .product-action -->
										<div class="product-action product-action-dark"> <a href="#" class="btn-product btn-cart" title="Add to cart"><span>add to cart</span></a> <a href="popup/quickView.html" class="btn-product btn-quickview" title="Quick view"><span>quick view</span></a> </div>
										<!-- End .product-action -->
									...
									<!-- End .product-media -->
									<div class="product-body">
										<div class="product-cat"> <a href="#">Computers & Tablets</a> </div>
										<!-- End .product-cat -->
										<h3 class="product-title"><a href="product.html">Apple - Smart Keyboard Folio  for 11-inch iPad Pro</a></h3>
										<!-- End .product-title -->
										<div class="product-price"> <span class="new-price">$179.00</span> <span class="old-price">Was $200.99</span> </div>
										<!-- End .product-price -->
										<div class="ratings-container">
											<div class="ratings">
												<div class="ratings-val" style="width: 60%;"></div>
			...
			<!-- End .row -->
			<div class="more-container text-center mt-3 mb-0"> <a href="#" class="btn btn-outline-dark-2 btn-round btn-more"><span>Shop more Outlet deals</span><i class="icon-long-arrow-right"></i></a> </div>
			<!-- End .more-container -->
		</div>
		<!-- End .container -->
	</div>
	...
	<div class="container trending">
		<div class="heading heading-flex mb-3">
			...
			<div class="heading-right">
                ...
                @endphp
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="trending-all-link" data-toggle="tab" href="#trending-{{ $category->pro_cate_slug}}-tab" role="tab" aria-controls="trending-{{ $category->pro_cate_slug}}-tab" aria-selected="false">{{ $category->pro_cate_name}}</a>
                     </li>
                    @endforeach
		...
		<div class="row">
			<div class="col-xl-5col d-none d-xl-block">
				<div class="banner">
					<a href="#"> <img src="{{asset('content/website')}}/assets/images/demos/demo-3/banners/banner-4.jpg" alt="banner"> </a>
				</div>
				<!-- End .banner -->
			</div>
			<!-- End .col-xl-5col -->
			<div class="col-xl-4-5col">
				<div class="tab-content tab-content-carousel just-action-icons-sm">
                 @php
                    $allproducts = App\Models\Product::orderBy('product_id','ASC')->where('product_status', 1)->get();
                @endphp
                        ...
                        @foreach ( $allproducts as $allproducat )
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    @elseif ($allproducat->product_feature == 2)
                                    <span class="product-label label-circle label-top">Sale</span>
                                    @else
                                    <span class="product-label label-circle label-sale">Top</span>
                                    @endif
                                ...
                                <!-- End .product-media -->
                                <div class="product-body">
                                    <div class="product-cat"> <a href="{{ url('productview/'.$allproducat->product_slug) }}">{{ $allproducat->category->pro_cate_name }}</a> </div>
                                    <!-- End .product-cat -->
                                    <h3 class="product-title"><a href="{{ url('productview/'.$allproducat->product_slug) }}">{{ Str::words($allproducat->product_name,5) }}</a></h3>
                                    <!-- End .product-title -->
                    ...
                    @foreach ( $categories as $category)
                @php
                    $products = App\Models\Product::where('pro_category_id', $category->pro_cate_id)->orderBy('product_id', 'DESC')->limit(6)->get();
                @endphp
					<div class="tab-pane p-0 fade" id="trending-{{ $category->pro_cate_slug }}-tab" role="tabpanel" aria-labelledby="trending-{{ $category->pro_cate_slug }}-tab">
						<div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                        "nav": true,
                                        "dots": false,
                                        "margin": 20,
                        ...
                        @foreach ( $products as $catproducat)
                            <div class="product product-2">
                                <figure class="product-media">
                                    @if ($catproducat->product_feature == 1)
                                    <span class="product-label label-circle label-new">New</span>
                                    @elseif ($catproducat->product_feature == 2)
                                    <span class="product-label label-circle label-top">Sale</span>
                                    @else
                                    <span class="product-label label-circle label-sale">Top</span>
                                    @endif
                                ...
                                <!-- End .product-media -->
                                <div class="product-body">
                                    <div class="product-cat"> <a href="{{ url('productview/'.$catproducat->product_slug) }}">{{ $catproducat->category->pro_cate_name }}</a> </div>
                                    <!-- End .product-cat -->
                                    <h3 class="product-title"><a href="{{ url('productview/'.$catproducat->product_slug) }}">{{ Str::words($catproducat->product_name,6 )}}</a></h3>
                                    <!-- End .product-title -->
	...
	<div class="container top">
		<div class="heading heading-flex mb-3">
			...
			<div class="heading-right">
				<ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
					<li class="nav-item"> <a class="nav-link active" id="top-all-link" data-toggle="tab" href="#top-all-tab" role="tab" aria-controls="top-all-tab" aria-selected="true">All</a> </li>
                    @php
                        $categories = App\Models\Prodcategory::where('pro_cate_status', 1)->orderBy('pro_cate_id' , 'DESC')->limit(5)->get();
                    @endphp
                    @foreach ($categories as $category)
					<li class="nav-item"> <a class="nav-link" id="top-tv-link" data-toggle="tab" href="#top-{{ $category->pro_cate_slug }}-tab" role="tab" aria-controls="top-tv-tab" aria-selected="false">{{ $category->pro_cate_name }}</a> </li>
                    @endforeach
				</ul>
			</div>
			<!-- End .heading-right -->
		...
		<div class="tab-content tab-content-carousel just-action-icons-sm">
            @php
                $topproducts = App\Models\Product::where('product_status', 1)->orderBy('product_id', 'DESC')->get();
            @endphp
            ...
            <div class="tab-pane p-0 fade show active" id="top-all-tab" role="tabpanel" aria-labelledby="top-all-link">
				<div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    @if ($topproduct->product_feature == 1)
                                    <span class="product-label label-circle label-new">New</span>
                                    @elseif ($topproduct->product_feature == 2)
                                    <span class="product-label label-circle label-top">Sale</span>
                                    @else
                                    <span class="product-label label-circle label-sale">Top</span>
                                    @endif
                                ...
                                <!-- End .product-media -->
                                <div class="product-body">
                                    <div class="product-cat"> <a href="{{ url('productview/'.$topproduct->product_slug) }}">{{ $topproduct->category->pro_cate_name }}</a> </div>
                                    <!-- End .product-cat -->
                                    <h3 class="product-title"><a href="{{ url('productview/'.$topproduct->product_slug) }}">{{ $topproduct->product_name }}</a></h3>
                                    <!-- End .product-title -->
                                    <div class="product-price"> ৳ {{ $topproduct->product_price }} </div>
                                    <!-- End .product-price -->
                                    <div class="ratings-container">
                                        <div class="ratings">
                                            <div class="ratings-val" style="width: 100%;"></div>
			...
			<!-- .End .tab-pane -->
            @php
                $tproducts = App\Models\Product::where('pro_category_id', $category->pro_cate_id)->orderBy('product_id', 'DESC')->limit(6)->get();
            @endphp

			<div class="tab-pane p-0 fade" id="top-{{ $category->pro_cate_slug }}-tab" role="tabpanel" aria-labelledby="top-tv-link">
				<div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                "nav": true,
                                "dots": false,
                                "margin": 20,
                    ...
                    @foreach ($tproducts as $tproduct)
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                @if ($tproduct->product_feature == 1)
                                <span class="product-label label-circle label-new">New</span>
                                @elseif ($tproduct->product_feature == 2)
                                <span class="product-label label-circle label-top">Sale</span>
                                @else
                                <span class="product-label label-circle label-sale">Top</span>
                                @endif
                            ...
                            <!-- End .product-media -->
                            <div class="product-body">
                                <div class="product-cat"> <a href="{{ url('productview/'.$tproduct->product_slug) }}">{{ $tproduct->category->pro_cate_name }}</a> </div>
                                <!-- End .product-cat -->
                                <h3 class="product-title"><a href="{{ url('productview/'.$tproduct->product_slug) }}">{{ $tproduct->product_name }} </a></h3>
                                <!-- End .product-title -->
                                <div class="product-price"> ৳ {{ $tproduct->product_price }} </div>
                                <!-- End .product-price -->
                                <div class="ratings-container">
                                    <div class="ratings">
                                        <div class="ratings-val" style="width: 80%;"></div>
	...
	<div class="container">
		<div class="cta cta-separator cta-border-image cta-half mb-0" style="background-image: url({{asset('content/website')}}/assets/images/demos/demo-3/bg-2.jpg);">
			<div class="cta-border-wrapper bg-white">
				<div class="row">
					<div class="col-lg-6">
						<div class="cta-wrapper cta-text text-center">
							...
							<!-- End .cta-title -->
							<p class="cta-desc">Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci. </p>
							<!-- End .cta-desc -->
							<div class="social-icons social-icons-colored justify-content-center"> <a href="#" class="social-icon social-facebook" title="Facebook" target="_blank"><i class="icon-facebook-f"></i></a> <a href="#" class="social-icon social-twitter" title="Twitter" target="_blank"><i class="icon-twitter"></i></a> <a href="#" class="social-icon social-instagram" title="Instagram" target="_blank"><i class="icon-instagram"></i></a> <a href="#" class="social-icon social-youtube" title="Youtube" target="_blank"><i class="icon-youtube"></i></a> <a href="#" class="social-icon social-pinterest" title="Pinterest" target="_blank"><i class="icon-pinterest"></i></a> </div>
							<!-- End .soial-icons -->
						</div>
						<!-- End .cta-wrapper -->
					</div>
					...
					<div class="col-lg-6">
						<div class="cta-wrapper text-center">
							...
							<!-- End .cta-title -->
							<p class="cta-desc">and
								<br>receive <span class="text-primary">$20 coupon</span> for first shopping</p>
							<!-- End .cta-desc -->
							<form action="#">
