...
<main class="main">
	<div class="page-header text-center" style="background-image: url('{{asset('content/website')}}/assets/images/page-header-bg.jpg')">
		<div class="container-fluid">
			<h1 class="page-title">Product Category <span>Shop</span></h1> </div>
		<!-- End .container-fluid -->
	</div>
	<!-- End .page-header -->
	<nav aria-label="breadcrumb" class="breadcrumb-nav breadcrumb-with-filter">
		<div class="container-fluid"> <a href="#" class="sidebar-toggler"><i class="icon-bars"></i>Filters</a>
			<ol class="breadcrumb">
				...
				<div class="row">
						...
						<div class="row">
							<div class="col-sm-8">
								<div class="banner banner-cat banner-badge">
									<a href="#"> <img src="{{asset('content/website')}}/assets/images/category/fullwidth-page/banner-1.jpg" alt="Banner"> </a>
									<a class="banner-link" href="#">
										<h3 class="banner-title">Jackets</h3>
										<!-- End .banner-title -->
										<h4 class="banner-subtitle">2 Products</h4>
										<!-- End .banner-subtitle --><span class="banner-link-text">Shop Now</span> </a>
									<!-- End .banner-link -->
								</div>
								<!-- End .banner -->
							</div>
							...
							<div class="col-sm-4">
								<div class="banner banner-cat banner-badge">
									<a href="#"> <img src="{{asset('content/website')}}/assets/images/category/fullwidth-page/banner-2.jpg" alt="Banner"> </a>
									<a class="banner-link" href="#">
							...
							<div class="col-sm-4">
								<div class="banner banner-cat banner-badge">
									<a href="#"> <img src="{{asset('content/website')}}/assets/images/category/fullwidth-page/banner-3.jpg" alt="Banner"> </a>
									<a class="banner-link" href="#">
							...
							<div class="col-sm-8">
								<div class="banner banner-cat banner-badge">
									<a href="#"> <img src="{{asset('content/website')}}/assets/images/category/fullwidth-page/banner-4.jpg" alt="Banner"> </a>
									<a class="banner-link" href="#">
					...
					<div class="col-lg-6">
						<div class="row">
							<div class="col-sm-8">
								<div class="banner banner-cat banner-badge">
									<a href="#"> <img src="{{asset('content/website')}}/assets/images/category/fullwidth-page/banner-5.jpg" alt="Banner"> </a>
									<a class="banner-link" href="#">
								...
								<!-- End .banner -->
								<div class="banner banner-cat banner-badge">
									<a href="#"> <img src="{{asset('content/website')}}/assets/images/category/fullwidth-page/banner-6.jpg" alt="Banner"> </a>
									<a class="banner-link" href="#">
							...
							<div class="col-sm-4">
								<div class="banner banner-cat banner-badge">
									<a href="#"> <img src="{{asset('content/website')}}/assets/images/category/fullwidth-page/banner-7.jpg" alt="Banner"> </a>
									<a class="banner-link" href="#">
								...
								<!-- End .banner -->
								<div class="banner banner-cat banner-badge">
									<a href="#"> <img src="{{asset('content/website')}}/assets/images/category/fullwidth-page/banner-8.jpg" alt="Banner"> </a>
									<a class="banner-link" href="#">
					...
					<div class="widget-body">
						<div class="filter-items filter-items-count">
							...
							<div class="filter-item">
								...
								<!-- End .custom-checkbox --><span class="item-count">13</span> </div>
							<!-- End .filter-item -->
