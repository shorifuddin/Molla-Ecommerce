			...
			<div class="card-header bg-secondary card_header">
                <div class="row">
                  ...
                  <div class="col-md-4 card_header_btn ">
                    <a href="{{ url('/dashboard/user/add') }}" class="btn btn-xs btn-dark " style="float: right; color:white;"><i class="md md-view-module"></i> Add User</a>
                  </div>
                </div>
            </div> 
			<div class="card-body">
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h3 class="card-title">Buttons example</h3> </div>
			<div class="card-body">
				<table id="datatable-buttons" id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
					<thead class="thead-dark">
						<tr>
							<th>Name</th>
							<th>Position</th>
