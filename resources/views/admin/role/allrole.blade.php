      ...
      <div class="card-body container">
          <table class="table table-bordered table-striped table-hover custom_table">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <button  class="dropdown-item" data-toggle="modal" data-target="#con-close-modal{{ $data->role_id }}">Delete</button>
                            </li>
                            @endif
                        </ul>
                    </div>
              ...
              {{-- Modal --}}
								<div id="con-close-modal{{ $data->role_id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
