                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ url('/dashboard/cupon/view/'.$data->coupon_id) }}" class="dropdown-item">View</a></li>
                            @if(Auth::user()->role=='1' )
                            <li><a href="{{ url('/dashboard/cupon/edit/'.$data->coupon_id) }}" class="dropdown-item">Edit</a></li>
                            <li>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a href="{{ url('/dashboard/cupon/softdelete/'.$data->coupon_id) }}" class="btn btn-danger waves-effect waves-light">Delete</a>
											</div>
										</div>
									</div>
								</div>
