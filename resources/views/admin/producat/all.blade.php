									...
									<td>
										<div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <button  class="dropdown-item" data-toggle="modal" data-target="#con-close-modal{{ $data->product_id }}">Delete</button>
                                                    {{-- <a  class="dropdown-item" data-toggle="modal" data-target="#con-close-modal{{ $data->product_id }}">Delete</a> --}}
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
